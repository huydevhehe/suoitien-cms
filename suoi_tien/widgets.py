...
class MultiLangWidget(forms.MultiWidget):
    ...
    def decompress(self, value):
        if value:
            # Bóc tách ngôn ngữ tiếng Việt (vi) và tiếng Anh (en)
            ...
            # Nếu không tìm thấy thẻ tag nào, mặc định coi toàn bộ nội dung là tiếng Việt
    ...
    def value_from_datadict(self, data, files, name):
        ...
        # Nếu cả 2 đều trống, trả về chuỗi rỗng
        if not vi_val and not en_val:
            return ""
            
        # Ghép chuỗi theo chuẩn của CMS PHP cũ trước khi lưu vào database
